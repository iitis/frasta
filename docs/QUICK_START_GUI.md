...
**Cel**: Obrócenie powierzchni o 45°
...
Na pasku narzędzi (toolbar) znajdziesz nowe przyciski:

```
[📂] [💾] [💾💾] │ [🔧] [↕️] [↔️] [↻] [⚫⚪] [💧] [↗️] [🎨] │ [🔹] [📐] [🔄] │ [📦] [⚖️] [📊] │ [ℹ️] [❌]
                                                        └──┬──┘
                                                           │
                                              Nowe funkcje przetwarzania!
```
...
- **Szczegółowa dokumentacja**: [docs/GUI_INTEGRATION.md](docs/GUI_INTEGRATION.md)
- **API dokumentacja**: [docs/ADVANCED_PROCESSING.md](docs/ADVANCED_PROCESSING.md)
